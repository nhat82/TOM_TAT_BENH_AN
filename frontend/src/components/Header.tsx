  ...
  return (
    <header className="bg-white border-b border-outline-variant sticky top-0 z-30 flex items-center justify-between gap-8 px-10 py-[18px]">
      <div className="flex items-center gap-[14px] flex-none cursor-pointer" onClick={() => navigate('/')}>
        <div className="w-10 h-10 rounded-[6px] bg-primary flex items-center justify-center flex-none shadow-[0_4px_12px_rgba(47,111,237,.35)]">
      ...
      <div className="flex-1 max-w-[520px] relative flex items-center">
        ...
        <input
          ...
          className="w-full pl-[46px] pr-[18px] py-[13px] border border-outline-variant rounded-[7px] bg-surface-container-low text-[15px] text-on-surface placeholder:text-on-surface-variant outline-none focus:border-primary focus:ring-1 focus:ring-primary/30 transition-colors"
        />
      </div>
      ...
      <div className="flex items-center gap-4 flex-none">
        ...
        <div className="w-11 h-11 rounded-[7px] bg-primary-container flex items-center justify-center flex-none">
